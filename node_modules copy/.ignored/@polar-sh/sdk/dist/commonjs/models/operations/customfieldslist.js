...
const customfieldsortproperty_js_1 = require("../components/customfieldsortproperty.js");
const customfieldtype_js_1 = require("../components/customfieldtype.js");
const listresourcecustomfield_js_1 = require("../components/listresourcecustomfield.js");
/** @internal */
...
exports.CustomFieldTypeFilter$inboundSchema = z.union([
    customfieldtype_js_1.CustomFieldType$inboundSchema,
    z.array(customfieldtype_js_1.CustomFieldType$inboundSchema),
]);
/** @internal */
exports.CustomFieldTypeFilter$outboundSchema = z.union([
    customfieldtype_js_1.CustomFieldType$outboundSchema,
    z.array(customfieldtype_js_1.CustomFieldType$outboundSchema),
]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
...
exports.CustomFieldsListRequest$inboundSchema = z.object({
    ...
    sorting: z.nullable(z.array(customfieldsortproperty_js_1.CustomFieldSortProperty$inboundSchema))
        .optional(),
}).transform((v) => {
...
exports.CustomFieldsListRequest$outboundSchema = z.object({
    ...
    page: z.number().int().default(1),
    limit: z.number().int().default(10),
    sorting: z.nullable(z.array(customfieldsortproperty_js_1.CustomFieldSortProperty$outboundSchema))
        .optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
...
exports.CustomFieldsListResponse$inboundSchema = z.object({
    Result: listresourcecustomfield_js_1.ListResourceCustomField$inboundSchema,
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        "Result": "result",
    });
...
exports.CustomFieldsListResponse$outboundSchema = z.object({
    result: listresourcecustomfield_js_1.ListResourceCustomField$outboundSchema,
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        result: "Result",
    });
