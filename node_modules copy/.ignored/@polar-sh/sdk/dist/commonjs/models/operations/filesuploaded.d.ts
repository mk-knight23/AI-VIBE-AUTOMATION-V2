 ...
 */
export type FilesUploadedResponseFilesUploaded = (ProductMediaFileRead & {
...
/** @internal */
export type FilesUploadedResponseFilesUploaded$Outbound = (ProductMediaFileRead$Outbound & {
    service: "product_media";
