...
export type CustomFieldCreateNumberMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type CustomFieldCreateNumberMetadata$Outbound = string | number | number | boolean;
/** @internal */
