...
const customerbenefitgrantmetercreditupdate_js_1 = require("./customerbenefitgrantmetercreditupdate.js");
/** @internal */
exports.CustomerBenefitGrantUpdate$inboundSchema = z.union([
    ...
    customerbenefitgrantmetercreditupdate_js_1.CustomerBenefitGrantMeterCreditUpdate$inboundSchema.and(z.object({ benefit_type: z.literal("meter_credit") }).transform((v) => ({
        benefitType: v.benefit_type,
    }))),
]);
/** @internal */
exports.CustomerBenefitGrantUpdate$outboundSchema = z.union([
    ...
    customerbenefitgrantmetercreditupdate_js_1.CustomerBenefitGrantMeterCreditUpdate$outboundSchema.and(z.object({ benefitType: z.literal("meter_credit") }).transform((v) => ({
        benefit_type: v.benefitType,
    }))),
]);
/**
