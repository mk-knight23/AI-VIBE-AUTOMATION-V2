...
export type DiscountPercentageRepeatDurationCreateMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type DiscountPercentageRepeatDurationCreateMetadata$Outbound = string | number | number | boolean;
/** @internal */
