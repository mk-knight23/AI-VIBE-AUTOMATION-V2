...
export type DiscountFixedOnceForeverDurationCreateMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type DiscountFixedOnceForeverDurationCreateMetadata$Outbound = string | number | number | boolean;
/** @internal */
