...
import { CustomerBenefitGrantMeterCredit, CustomerBenefitGrantMeterCredit$Outbound } from "./customerbenefitgrantmetercredit.js";
export type CustomerBenefitGrant = CustomerBenefitGrantDiscord | CustomerBenefitGrantGitHubRepository | CustomerBenefitGrantDownloadables | CustomerBenefitGrantLicenseKeys | CustomerBenefitGrantCustom | CustomerBenefitGrantMeterCredit;
/** @internal */
export declare const CustomerBenefitGrant$inboundSchema: z.ZodType<CustomerBenefitGrant, z.ZodTypeDef, unknown>;
/** @internal */
export type CustomerBenefitGrant$Outbound = CustomerBenefitGrantDiscord$Outbound | CustomerBenefitGrantGitHubRepository$Outbound | CustomerBenefitGrantDownloadables$Outbound | CustomerBenefitGrantLicenseKeys$Outbound | CustomerBenefitGrantCustom$Outbound | CustomerBenefitGrantMeterCredit$Outbound;
/** @internal */
