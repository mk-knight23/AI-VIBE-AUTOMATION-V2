...
/** @internal */
exports.ProductUpdateMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
...
exports.Two$inboundSchema = z.union([
    productpricemeteredunitcreate_js_1.ProductPriceMeteredUnitCreate$inboundSchema.and(z.object({ amount_type: z.literal("metered_unit") }).transform((v) => ({
        amountType: v.amount_type,
    }))),
    productpricefixedcreate_js_1.ProductPriceFixedCreate$inboundSchema.and(z.object({ amount_type: z.literal("fixed") }).transform((v) => ({
        amountType: v.amount_type,
    }))),
    productpriceseatbasedcreate_js_1.ProductPriceSeatBasedCreate$inboundSchema.and(z.object({ amount_type: z.literal("seat_based") }).transform((v) => ({
        amountType: v.amount_type,
    }))),
    productpricecustomcreate_js_1.ProductPriceCustomCreate$inboundSchema.and(z.object({ amount_type: z.literal("custom") }).transform((v) => ({
        amountType: v.amount_type,
    }))),
    productpricefreecreate_js_1.ProductPriceFreeCreate$inboundSchema.and(z.object({ amount_type: z.literal("free") }).transform((v) => ({
        amountType: v.amount_type,
    }))),
]);
/** @internal */
exports.Two$outboundSchema = z
    .union([
    productpricemeteredunitcreate_js_1.ProductPriceMeteredUnitCreate$outboundSchema.and(z.object({ amountType: z.literal("metered_unit") }).transform((v) => ({
        amount_type: v.amountType,
    }))),
    productpricefixedcreate_js_1.ProductPriceFixedCreate$outboundSchema.and(z.object({ amountType: z.literal("fixed") }).transform((v) => ({
        amount_type: v.amountType,
    }))),
    productpriceseatbasedcreate_js_1.ProductPriceSeatBasedCreate$outboundSchema.and(z.object({ amountType: z.literal("seat_based") }).transform((v) => ({
        amount_type: v.amountType,
    }))),
    productpricecustomcreate_js_1.ProductPriceCustomCreate$outboundSchema.and(z.object({ amountType: z.literal("custom") }).transform((v) => ({
        amount_type: v.amountType,
    }))),
    productpricefreecreate_js_1.ProductPriceFreeCreate$outboundSchema.and(z.object({ amountType: z.literal("free") }).transform((v) => ({
        amount_type: v.amountType,
    }))),
]);
/**
...
exports.ProductUpdate$inboundSchema = z.object({
    ...
    prices: z.nullable(z.array(z.union([
        existingproductprice_js_1.ExistingProductPrice$inboundSchema,
        z.union([
            productpricemeteredunitcreate_js_1.ProductPriceMeteredUnitCreate$inboundSchema.and(z.object({ amount_type: z.literal("metered_unit") }).transform((v) => ({ amountType: v.amount_type }))),
            productpricefixedcreate_js_1.ProductPriceFixedCreate$inboundSchema.and(z.object({ amount_type: z.literal("fixed") }).transform((v) => ({
                amountType: v.amount_type,
            }))),
            productpriceseatbasedcreate_js_1.ProductPriceSeatBasedCreate$inboundSchema.and(z.object({ amount_type: z.literal("seat_based") }).transform((v) => ({ amountType: v.amount_type }))),
            productpricecustomcreate_js_1.ProductPriceCustomCreate$inboundSchema.and(z.object({ amount_type: z.literal("custom") }).transform((v) => ({
                amountType: v.amount_type,
            }))),
            productpricefreecreate_js_1.ProductPriceFreeCreate$inboundSchema.and(z.object({ amount_type: z.literal("free") }).transform((v) => ({
...
exports.ProductUpdate$outboundSchema = z.object({
    ...
    prices: z.nullable(z.array(z.union([
        existingproductprice_js_1.ExistingProductPrice$outboundSchema,
        z.union([
            productpricemeteredunitcreate_js_1.ProductPriceMeteredUnitCreate$outboundSchema.and(z.object({ amountType: z.literal("metered_unit") }).transform((v) => ({ amount_type: v.amountType }))),
            productpricefixedcreate_js_1.ProductPriceFixedCreate$outboundSchema.and(z.object({ amountType: z.literal("fixed") }).transform((v) => ({
                amount_type: v.amountType,
            }))),
            productpriceseatbasedcreate_js_1.ProductPriceSeatBasedCreate$outboundSchema.and(z.object({ amountType: z.literal("seat_based") }).transform((v) => ({ amount_type: v.amountType }))),
            productpricecustomcreate_js_1.ProductPriceCustomCreate$outboundSchema.and(z.object({ amountType: z.literal("custom") }).transform((v) => ({
                amount_type: v.amountType,
            }))),
            productpricefreecreate_js_1.ProductPriceFreeCreate$outboundSchema.and(z.object({ amountType: z.literal("free") }).transform((v) => ({
