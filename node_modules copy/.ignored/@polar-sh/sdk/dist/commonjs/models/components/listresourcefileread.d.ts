...
export type FileRead = (OrganizationAvatarFileRead & {
...
export type ListResourceFileRead = {
    items: Array<(OrganizationAvatarFileRead & {
        service: "organization_avatar";
    }) | (ProductMediaFileRead & {
        service: "product_media";
    }) | (DownloadableFileRead & {
...
/** @internal */
export type FileRead$Outbound = (OrganizationAvatarFileRead$Outbound & {
    service: "organization_avatar";
...
export type ListResourceFileRead$Outbound = {
    items: Array<(OrganizationAvatarFileRead$Outbound & {
        service: "organization_avatar";
    }) | (ProductMediaFileRead$Outbound & {
        service: "product_media";
    }) | (DownloadableFileRead$Outbound & {
