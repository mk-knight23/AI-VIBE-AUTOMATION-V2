...
export type BenefitLicenseKeysSubscriberMetadata = string | number | number | boolean;
...
/** @internal */
export declare const BenefitLicenseKeysSubscriberMetadata$inboundSchema: z.ZodType<BenefitLicenseKeysSubscriberMetadata, z.ZodTypeDef, unknown>;
/** @internal */
export type BenefitLicenseKeysSubscriberMetadata$Outbound = string | number | number | boolean;
/** @internal */
export declare const BenefitLicenseKeysSubscriberMetadata$outboundSchema: z.ZodType<BenefitLicenseKeysSubscriberMetadata$Outbound, z.ZodTypeDef, BenefitLicenseKeysSubscriberMetadata>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace BenefitLicenseKeysSubscriberMetadata$ {
    /** @deprecated use `BenefitLicenseKeysSubscriberMetadata$inboundSchema` instead. */
    const inboundSchema: z.ZodType<BenefitLicenseKeysSubscriberMetadata, z.ZodTypeDef, unknown>;
    /** @deprecated use `BenefitLicenseKeysSubscriberMetadata$outboundSchema` instead. */
    const outboundSchema: z.ZodType<BenefitLicenseKeysSubscriberMetadata$Outbound, z.ZodTypeDef, BenefitLicenseKeysSubscriberMetadata>;
    /** @deprecated use `BenefitLicenseKeysSubscriberMetadata$Outbound` instead. */
    type Outbound = BenefitLicenseKeysSubscriberMetadata$Outbound;
}
export declare function benefitLicenseKeysSubscriberMetadataToJSON(benefitLicenseKeysSubscriberMetadata: BenefitLicenseKeysSubscriberMetadata): string;
export declare function benefitLicenseKeysSubscriberMetadataFromJSON(jsonString: string): SafeParseResult<BenefitLicenseKeysSubscriberMetadata, SDKValidationError>;
/** @internal */
