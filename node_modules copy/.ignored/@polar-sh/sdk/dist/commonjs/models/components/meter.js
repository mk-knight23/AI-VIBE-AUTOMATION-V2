...
const uniqueaggregation_js_1 = require("./uniqueaggregation.js");
/** @internal */
...
exports.MeterAggregation$inboundSchema = z.union([
    ...
    uniqueaggregation_js_1.UniqueAggregation$inboundSchema.and(z.object({ func: z.literal("unique") }).transform((v) => ({
        func: v.func,
    }))),
...
exports.MeterAggregation$outboundSchema = z.union([
    ...
    uniqueaggregation_js_1.UniqueAggregation$outboundSchema.and(z.object({ func: z.literal("unique") }).transform((v) => ({
        func: v.func,
    }))),
...
exports.Meter$inboundSchema = z
    ...
    archived_at: z.nullable(z.string().datetime({ offset: true }).transform(v => new Date(v))).optional(),
}).transform((v) => {
