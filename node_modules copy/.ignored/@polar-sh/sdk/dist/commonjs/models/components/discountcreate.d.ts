...
export type DiscountCreate = DiscountFixedRepeatDurationCreate | DiscountPercentageRepeatDurationCreate | DiscountFixedOnceForeverDurationCreate | DiscountPercentageOnceForeverDurationCreate;
/** @internal */
export declare const DiscountCreate$inboundSchema: z.ZodType<DiscountCreate, z.ZodTypeDef, unknown>;
/** @internal */
export type DiscountCreate$Outbound = DiscountFixedRepeatDurationCreate$Outbound | DiscountPercentageRepeatDurationCreate$Outbound | DiscountFixedOnceForeverDurationCreate$Outbound | DiscountPercentageOnceForeverDurationCreate$Outbound;
/** @internal */
