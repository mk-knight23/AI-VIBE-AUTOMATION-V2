...
export type CustomFieldUpdateSelectMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type CustomFieldUpdateSelectMetadata$Outbound = string | number | number | boolean;
/** @internal */
