...
exports.Address$ = exports.Address$outboundSchema = exports.Address$inboundSchema = exports.CountryAlpha2$ = exports.CountryAlpha2$outboundSchema = exports.CountryAlpha2$inboundSchema = exports.CountryAlpha2 = void 0;
...
/** @internal */
exports.CountryAlpha2$outboundSchema = exports.CountryAlpha2$inboundSchema;
/**
 * @internal
...
(function (CountryAlpha2$) {
    ...
    CountryAlpha2$.inboundSchema = exports.CountryAlpha2$inboundSchema;
    /** @deprecated use `CountryAlpha2$outboundSchema` instead. */
    CountryAlpha2$.outboundSchema = exports.CountryAlpha2$outboundSchema;
...
exports.Address$inboundSchema = z.object({
    ...
    country: exports.CountryAlpha2$inboundSchema,
}).transform((v) => {
...
exports.Address$outboundSchema = z.object({
    ...
    city: z.nullable(z.string()).optional(),
    state: z.nullable(z.string()).optional(),
    country: exports.CountryAlpha2$outboundSchema,
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
