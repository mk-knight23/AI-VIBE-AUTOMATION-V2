...
/** @internal */
export declare const MetricsTotalsCosts$inboundSchema: z.ZodType<MetricsTotalsCosts, z.ZodTypeDef, unknown>;
/** @internal */
export type MetricsTotalsCosts$Outbound = number | number;
/** @internal */
export declare const MetricsTotalsCosts$outboundSchema: z.ZodType<MetricsTotalsCosts$Outbound, z.ZodTypeDef, MetricsTotalsCosts>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace MetricsTotalsCosts$ {
    /** @deprecated use `MetricsTotalsCosts$inboundSchema` instead. */
    const inboundSchema: z.ZodType<number, z.ZodTypeDef, unknown>;
    /** @deprecated use `MetricsTotalsCosts$outboundSchema` instead. */
    const outboundSchema: z.ZodType<number, z.ZodTypeDef, number>;
    /** @deprecated use `MetricsTotalsCosts$Outbound` instead. */
    type Outbound = MetricsTotalsCosts$Outbound;
}
export declare function metricsTotalsCostsToJSON(metricsTotalsCosts: MetricsTotalsCosts): string;
export declare function metricsTotalsCostsFromJSON(jsonString: string): SafeParseResult<MetricsTotalsCosts, SDKValidationError>;
/** @internal */
export declare const MetricsTotalsCumulativeCosts$inboundSchema: z.ZodType<MetricsTotalsCumulativeCosts, z.ZodTypeDef, unknown>;
/** @internal */
export type MetricsTotalsCumulativeCosts$Outbound = number | number;
/** @internal */
export declare const MetricsTotalsCumulativeCosts$outboundSchema: z.ZodType<MetricsTotalsCumulativeCosts$Outbound, z.ZodTypeDef, MetricsTotalsCumulativeCosts>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace MetricsTotalsCumulativeCosts$ {
    ...
    const outboundSchema: z.ZodType<number, z.ZodTypeDef, number>;
    /** @deprecated use `MetricsTotalsCumulativeCosts$Outbound` instead. */
    type Outbound = MetricsTotalsCumulativeCosts$Outbound;
}
export declare function metricsTotalsCumulativeCostsToJSON(metricsTotalsCumulativeCosts: MetricsTotalsCumulativeCosts): string;
export declare function metricsTotalsCumulativeCostsFromJSON(jsonString: string): SafeParseResult<MetricsTotalsCumulativeCosts, SDKValidationError>;
/** @internal */
