...
export type BenefitGrantGitHubRepositoryWebhook = {
    ...
    previousProperties?: BenefitGrantGitHubRepositoryProperties | null | undefined;
};
/** @internal */
export declare const BenefitGrantGitHubRepositoryWebhook$inboundSchema: z.ZodType<BenefitGrantGitHubRepositoryWebhook, z.ZodTypeDef, unknown>;
/** @internal */
export type BenefitGrantGitHubRepositoryWebhook$Outbound = {
    ...
    previous_properties?: BenefitGrantGitHubRepositoryProperties$Outbound | null | undefined;
};
/** @internal */
export declare const BenefitGrantGitHubRepositoryWebhook$outboundSchema: z.ZodType<BenefitGrantGitHubRepositoryWebhook$Outbound, z.ZodTypeDef, BenefitGrantGitHubRepositoryWebhook>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace BenefitGrantGitHubRepositoryWebhook$ {
    /** @deprecated use `BenefitGrantGitHubRepositoryWebhook$inboundSchema` instead. */
    const inboundSchema: z.ZodType<BenefitGrantGitHubRepositoryWebhook, z.ZodTypeDef, unknown>;
    /** @deprecated use `BenefitGrantGitHubRepositoryWebhook$outboundSchema` instead. */
    const outboundSchema: z.ZodType<BenefitGrantGitHubRepositoryWebhook$Outbound, z.ZodTypeDef, BenefitGrantGitHubRepositoryWebhook>;
    /** @deprecated use `BenefitGrantGitHubRepositoryWebhook$Outbound` instead. */
    type Outbound = BenefitGrantGitHubRepositoryWebhook$Outbound;
}
export declare function benefitGrantGitHubRepositoryWebhookToJSON(benefitGrantGitHubRepositoryWebhook: BenefitGrantGitHubRepositoryWebhook): string;
export declare function benefitGrantGitHubRepositoryWebhookFromJSON(jsonString: string): SafeParseResult<BenefitGrantGitHubRepositoryWebhook, SDKValidationError>;
//# sourceMappingURL=benefitgrantgithubrepositorywebhook.d.ts.map