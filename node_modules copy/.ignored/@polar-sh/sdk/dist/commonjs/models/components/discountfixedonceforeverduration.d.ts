...
export type DiscountFixedOnceForeverDurationMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type DiscountFixedOnceForeverDurationMetadata$Outbound = string | number | number | boolean;
/** @internal */
