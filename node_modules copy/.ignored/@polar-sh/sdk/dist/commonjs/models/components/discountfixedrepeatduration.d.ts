...
export type DiscountFixedRepeatDurationMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type DiscountFixedRepeatDurationMetadata$Outbound = string | number | number | boolean;
/** @internal */
