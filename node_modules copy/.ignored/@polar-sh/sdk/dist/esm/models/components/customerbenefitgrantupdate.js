...
import { CustomerBenefitGrantMeterCreditUpdate$inboundSchema, CustomerBenefitGrantMeterCreditUpdate$outboundSchema, } from "./customerbenefitgrantmetercreditupdate.js";
/** @internal */
export const CustomerBenefitGrantUpdate$inboundSchema = z.union([
    ...
    CustomerBenefitGrantMeterCreditUpdate$inboundSchema.and(z.object({ benefit_type: z.literal("meter_credit") }).transform((v) => ({
        benefitType: v.benefit_type,
    }))),
]);
/** @internal */
export const CustomerBenefitGrantUpdate$outboundSchema = z.union([
    ...
    CustomerBenefitGrantMeterCreditUpdate$outboundSchema.and(z.object({ benefitType: z.literal("meter_credit") }).transform((v) => ({
        benefit_type: v.benefitType,
    }))),
]);
/**
