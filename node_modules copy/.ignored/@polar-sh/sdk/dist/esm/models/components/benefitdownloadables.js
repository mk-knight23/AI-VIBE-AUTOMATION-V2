...
/** @internal */
export const BenefitDownloadablesMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const BenefitDownloadablesMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BenefitDownloadablesMetadata$;
(function (BenefitDownloadablesMetadata$) {
    /** @deprecated use `BenefitDownloadablesMetadata$inboundSchema` instead. */
    BenefitDownloadablesMetadata$.inboundSchema = BenefitDownloadablesMetadata$inboundSchema;
    /** @deprecated use `BenefitDownloadablesMetadata$outboundSchema` instead. */
    BenefitDownloadablesMetadata$.outboundSchema = BenefitDownloadablesMetadata$outboundSchema;
})(BenefitDownloadablesMetadata$ || (BenefitDownloadablesMetadata$ = {}));
export function benefitDownloadablesMetadataToJSON(benefitDownloadablesMetadata) {
    return JSON.stringify(BenefitDownloadablesMetadata$outboundSchema.parse(benefitDownloadablesMetadata));
}
export function benefitDownloadablesMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BenefitDownloadablesMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitDownloadablesMetadata' from JSON`);
}
/** @internal */
