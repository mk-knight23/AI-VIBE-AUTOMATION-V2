...
/** @internal */
export const BenefitGitHubRepositoryCreateMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const BenefitGitHubRepositoryCreateMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BenefitGitHubRepositoryCreateMetadata$;
(function (BenefitGitHubRepositoryCreateMetadata$) {
    /** @deprecated use `BenefitGitHubRepositoryCreateMetadata$inboundSchema` instead. */
    BenefitGitHubRepositoryCreateMetadata$.inboundSchema = BenefitGitHubRepositoryCreateMetadata$inboundSchema;
    /** @deprecated use `BenefitGitHubRepositoryCreateMetadata$outboundSchema` instead. */
    BenefitGitHubRepositoryCreateMetadata$.outboundSchema = BenefitGitHubRepositoryCreateMetadata$outboundSchema;
})(BenefitGitHubRepositoryCreateMetadata$ || (BenefitGitHubRepositoryCreateMetadata$ = {}));
export function benefitGitHubRepositoryCreateMetadataToJSON(benefitGitHubRepositoryCreateMetadata) {
    return JSON.stringify(BenefitGitHubRepositoryCreateMetadata$outboundSchema.parse(benefitGitHubRepositoryCreateMetadata));
}
export function benefitGitHubRepositoryCreateMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BenefitGitHubRepositoryCreateMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitGitHubRepositoryCreateMetadata' from JSON`);
}
/** @internal */
