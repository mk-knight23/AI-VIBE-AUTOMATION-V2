...
export type Discount = DiscountFixedRepeatDuration | DiscountFixedOnceForeverDuration | DiscountPercentageRepeatDuration | DiscountPercentageOnceForeverDuration;
/** @internal */
export declare const Discount$inboundSchema: z.ZodType<Discount, z.ZodTypeDef, unknown>;
/** @internal */
export type Discount$Outbound = DiscountFixedRepeatDuration$Outbound | DiscountFixedOnceForeverDuration$Outbound | DiscountPercentageRepeatDuration$Outbound | DiscountPercentageOnceForeverDuration$Outbound;
/** @internal */
