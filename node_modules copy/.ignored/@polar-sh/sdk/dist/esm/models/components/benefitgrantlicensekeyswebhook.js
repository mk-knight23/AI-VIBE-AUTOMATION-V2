...
/** @internal */
export const BenefitGrantLicenseKeysWebhook$inboundSchema = z.object({
    ...
    previous_properties: z.nullable(BenefitGrantLicenseKeysProperties$inboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
...
/** @internal */
export const BenefitGrantLicenseKeysWebhook$outboundSchema = z.object({
    ...
    previousProperties: z.nullable(BenefitGrantLicenseKeysProperties$outboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
 ...
 */
export var BenefitGrantLicenseKeysWebhook$;
(function (BenefitGrantLicenseKeysWebhook$) {
    /** @deprecated use `BenefitGrantLicenseKeysWebhook$inboundSchema` instead. */
    BenefitGrantLicenseKeysWebhook$.inboundSchema = BenefitGrantLicenseKeysWebhook$inboundSchema;
    /** @deprecated use `BenefitGrantLicenseKeysWebhook$outboundSchema` instead. */
    BenefitGrantLicenseKeysWebhook$.outboundSchema = BenefitGrantLicenseKeysWebhook$outboundSchema;
