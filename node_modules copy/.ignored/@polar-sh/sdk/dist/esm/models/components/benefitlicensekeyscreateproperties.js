...
import { BenefitLicenseKeyActivationCreateProperties$inboundSchema, BenefitLicenseKeyActivationCreateProperties$outboundSchema, } from "./benefitlicensekeyactivationcreateproperties.js";
...
export const BenefitLicenseKeysCreateProperties$inboundSchema = z.object({
    ...
    expires: z.nullable(BenefitLicenseKeyExpirationProperties$inboundSchema)
        .optional(),
    activations: z.nullable(BenefitLicenseKeyActivationCreateProperties$inboundSchema).optional(),
...
export const BenefitLicenseKeysCreateProperties$outboundSchema = z.object({
    ...
    expires: z.nullable(BenefitLicenseKeyExpirationProperties$outboundSchema)
        .optional(),
    activations: z.nullable(BenefitLicenseKeyActivationCreateProperties$outboundSchema).optional(),
