...
export type CustomFieldUpdateCheckboxMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type CustomFieldUpdateCheckboxMetadata$Outbound = string | number | number | boolean;
/** @internal */
