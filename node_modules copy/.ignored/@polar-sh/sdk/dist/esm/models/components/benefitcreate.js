...
import { BenefitMeterCreditCreate$inboundSchema, BenefitMeterCreditCreate$outboundSchema, } from "./benefitmetercreditcreate.js";
/** @internal */
export const BenefitCreate$inboundSchema = z.union([
    ...
    BenefitMeterCreditCreate$inboundSchema.and(z.object({ type: z.literal("meter_credit") }).transform((v) => ({
        type: v.type,
    }))),
]);
/** @internal */
export const BenefitCreate$outboundSchema = z.union([
    ...
    BenefitMeterCreditCreate$outboundSchema.and(z.object({ type: z.literal("meter_credit") }).transform((v) => ({
        type: v.type,
    }))),
]);
/**
