...
export type CustomFieldCreateSelectMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type CustomFieldCreateSelectMetadata$Outbound = string | number | number | boolean;
/** @internal */
