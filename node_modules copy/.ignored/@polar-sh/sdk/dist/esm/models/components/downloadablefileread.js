...
/** @internal */
export const DownloadableFileRead$inboundSchema = z.object({
    id: z.string(),
...
/** @internal */
export const DownloadableFileRead$outboundSchema = z.object({
    id: z.string(),
 ...
 */
export var DownloadableFileRead$;
(function (DownloadableFileRead$) {
    /** @deprecated use `DownloadableFileRead$inboundSchema` instead. */
    DownloadableFileRead$.inboundSchema = DownloadableFileRead$inboundSchema;
    /** @deprecated use `DownloadableFileRead$outboundSchema` instead. */
    DownloadableFileRead$.outboundSchema = DownloadableFileRead$outboundSchema;
})(DownloadableFileRead$ || (DownloadableFileRead$ = {}));
export function downloadableFileReadToJSON(downloadableFileRead) {
    return JSON.stringify(DownloadableFileRead$outboundSchema.parse(downloadableFileRead));
}
export function downloadableFileReadFromJSON(jsonString) {
    return safeParse(jsonString, (x) => DownloadableFileRead$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'DownloadableFileRead' from JSON`);
}
