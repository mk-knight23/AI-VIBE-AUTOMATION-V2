...
export declare const OrganizationSortProperty: {
    ...
    readonly NextReviewThreshold: "next_review_threshold";
    readonly MinusNextReviewThreshold: "-next_review_threshold";
    readonly DaysInStatus: "days_in_status";
    readonly MinusDaysInStatus: "-days_in_status";
};
