...
import { LicenseKeyActivationBase$inboundSchema, LicenseKeyActivationBase$outboundSchema, } from "./licensekeyactivationbase.js";
...
/** @internal */
export const LicenseKeyWithActivations$inboundSchema = z.object({
    id: z.string(),
...
/** @internal */
export const LicenseKeyWithActivations$outboundSchema = z.object({
    id: z.string(),
 ...
 */
export var LicenseKeyWithActivations$;
(function (LicenseKeyWithActivations$) {
    /** @deprecated use `LicenseKeyWithActivations$inboundSchema` instead. */
    LicenseKeyWithActivations$.inboundSchema = LicenseKeyWithActivations$inboundSchema;
    /** @deprecated use `LicenseKeyWithActivations$outboundSchema` instead. */
    LicenseKeyWithActivations$.outboundSchema = LicenseKeyWithActivations$outboundSchema;
})(LicenseKeyWithActivations$ || (LicenseKeyWithActivations$ = {}));
export function licenseKeyWithActivationsToJSON(licenseKeyWithActivations) {
    return JSON.stringify(LicenseKeyWithActivations$outboundSchema.parse(licenseKeyWithActivations));
}
export function licenseKeyWithActivationsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => LicenseKeyWithActivations$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'LicenseKeyWithActivations' from JSON`);
}
