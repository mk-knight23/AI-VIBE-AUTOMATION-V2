...
export type LegacyRecurringProductPrice = (LegacyRecurringProductPriceCustom & {
    amountType: "custom";
...
/** @internal */
export type LegacyRecurringProductPrice$Outbound = (LegacyRecurringProductPriceCustom$Outbound & {
    amount_type: "custom";
