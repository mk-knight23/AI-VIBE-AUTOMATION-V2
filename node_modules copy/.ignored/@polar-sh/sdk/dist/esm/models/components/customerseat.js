...
/** @internal */
export const CustomerSeat$inboundSchema = z.object({
...
/** @internal */
export const CustomerSeat$outboundSchema = z.object({
 ...
 */
export var CustomerSeat$;
(function (CustomerSeat$) {
    /** @deprecated use `CustomerSeat$inboundSchema` instead. */
    CustomerSeat$.inboundSchema = CustomerSeat$inboundSchema;
    /** @deprecated use `CustomerSeat$outboundSchema` instead. */
    CustomerSeat$.outboundSchema = CustomerSeat$outboundSchema;
