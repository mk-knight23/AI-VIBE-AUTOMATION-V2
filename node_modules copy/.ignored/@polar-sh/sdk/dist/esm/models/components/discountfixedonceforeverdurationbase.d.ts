...
export type DiscountFixedOnceForeverDurationBaseMetadata = string | number | number | boolean;
...
/** @internal */
export type DiscountFixedOnceForeverDurationBaseMetadata$Outbound = string | number | number | boolean;
/** @internal */
