...
/** @internal */
export const LicenseKeyActivateConditions$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const LicenseKeyActivateConditions$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
...
/** @internal */
export const LicenseKeyActivateMeta$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const LicenseKeyActivateMeta$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
export const LicenseKeyActivate$inboundSchema = z.object({
    ...
    meta: z.record(z.union([z.string(), z.number().int(), z.number(), z.boolean()])).optional(),
}).transform((v) => {
    return remap$(v, {
