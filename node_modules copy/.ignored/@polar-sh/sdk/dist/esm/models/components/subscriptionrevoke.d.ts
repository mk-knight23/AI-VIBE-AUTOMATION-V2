...
/** @internal */
export declare const SubscriptionRevoke$inboundSchema: z.ZodType<SubscriptionRevoke, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const SubscriptionRevoke$outboundSchema: z.ZodType<SubscriptionRevoke$Outbound, z.ZodTypeDef, SubscriptionRevoke>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace SubscriptionRevoke$ {
    /** @deprecated use `SubscriptionRevoke$inboundSchema` instead. */
    const inboundSchema: z.ZodType<SubscriptionRevoke, z.ZodTypeDef, unknown>;
    /** @deprecated use `SubscriptionRevoke$outboundSchema` instead. */
    const outboundSchema: z.ZodType<SubscriptionRevoke$Outbound, z.ZodTypeDef, SubscriptionRevoke>;
    /** @deprecated use `SubscriptionRevoke$Outbound` instead. */
    type Outbound = SubscriptionRevoke$Outbound;
}
export declare function subscriptionRevokeToJSON(subscriptionRevoke: SubscriptionRevoke): string;
export declare function subscriptionRevokeFromJSON(jsonString: string): SafeParseResult<SubscriptionRevoke, SDKValidationError>;
