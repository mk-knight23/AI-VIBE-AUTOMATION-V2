...
/** @internal */
export const LicenseKeyActivationReadMeta$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const LicenseKeyActivationReadMeta$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
