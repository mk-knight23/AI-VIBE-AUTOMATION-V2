...
/** @internal */
export const ProductUpdateMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const ProductUpdateMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
...
/** @internal */
export const Two$inboundSchema = z.union([
...
export const ProductUpdate$inboundSchema = z.object({
    ...
    prices: z.nullable(z.array(z.union([
        ExistingProductPrice$inboundSchema,
        z.union([
            ProductPriceMeteredUnitCreate$inboundSchema.and(z.object({ amount_type: z.literal("metered_unit") }).transform((v) => ({ amountType: v.amount_type }))),
            ProductPriceFixedCreate$inboundSchema.and(z.object({ amount_type: z.literal("fixed") }).transform((v) => ({
                amountType: v.amount_type,
            }))),
            ProductPriceSeatBasedCreate$inboundSchema.and(z.object({ amount_type: z.literal("seat_based") }).transform((v) => ({ amountType: v.amount_type }))),
            ProductPriceCustomCreate$inboundSchema.and(z.object({ amount_type: z.literal("custom") }).transform((v) => ({
                amountType: v.amount_type,
            }))),
            ProductPriceFreeCreate$inboundSchema.and(z.object({ amount_type: z.literal("free") }).transform((v) => ({
...
export const ProductUpdate$outboundSchema = z.object({
    ...
    prices: z.nullable(z.array(z.union([
        ExistingProductPrice$outboundSchema,
        z.union([
            ProductPriceMeteredUnitCreate$outboundSchema.and(z.object({ amountType: z.literal("metered_unit") }).transform((v) => ({ amount_type: v.amountType }))),
            ProductPriceFixedCreate$outboundSchema.and(z.object({ amountType: z.literal("fixed") }).transform((v) => ({
                amount_type: v.amountType,
            }))),
            ProductPriceSeatBasedCreate$outboundSchema.and(z.object({ amountType: z.literal("seat_based") }).transform((v) => ({ amount_type: v.amountType }))),
            ProductPriceCustomCreate$outboundSchema.and(z.object({ amountType: z.literal("custom") }).transform((v) => ({
                amount_type: v.amountType,
            }))),
            ProductPriceFreeCreate$outboundSchema.and(z.object({ amountType: z.literal("free") }).transform((v) => ({
