...
import { CustomerBenefitGrantMeterCreditUpdate, CustomerBenefitGrantMeterCreditUpdate$Outbound } from "./customerbenefitgrantmetercreditupdate.js";
export type CustomerBenefitGrantUpdate = (CustomerBenefitGrantDiscordUpdate & {
    benefitType: "discord";
...
/** @internal */
export type CustomerBenefitGrantUpdate$Outbound = (CustomerBenefitGrantDiscordUpdate$Outbound & {
