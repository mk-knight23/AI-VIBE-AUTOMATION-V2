...
import { SubscriptionCycledEvent$inboundSchema, SubscriptionCycledEvent$outboundSchema, } from "./subscriptioncycledevent.js";
import { SubscriptionProductUpdatedEvent$inboundSchema, SubscriptionProductUpdatedEvent$outboundSchema, } from "./subscriptionproductupdatedevent.js";
import { SubscriptionRevokedEvent$inboundSchema, SubscriptionRevokedEvent$outboundSchema, } from "./subscriptionrevokedevent.js";
/** @internal */
export const SystemEvent$inboundSchema = z.union([
    ...
    SubscriptionCycledEvent$inboundSchema.and(z.object({ name: z.literal("subscription.cycled") }).transform((v) => ({
        name: v.name,
    }))),
    SubscriptionProductUpdatedEvent$inboundSchema.and(z.object({ name: z.literal("subscription.product_updated") }).transform((v) => ({ name: v.name }))),
    SubscriptionRevokedEvent$inboundSchema.and(z.object({ name: z.literal("subscription.revoked") }).transform((v) => ({
        name: v.name,
    }))),
]);
/** @internal */
export const SystemEvent$outboundSchema = z.union([
    ...
    SubscriptionCycledEvent$outboundSchema.and(z.object({ name: z.literal("subscription.cycled") }).transform((v) => ({
        name: v.name,
    }))),
    SubscriptionProductUpdatedEvent$outboundSchema.and(z.object({ name: z.literal("subscription.product_updated") }).transform((v) => ({ name: v.name }))),
    SubscriptionRevokedEvent$outboundSchema.and(z.object({ name: z.literal("subscription.revoked") }).transform((v) => ({
        name: v.name,
    }))),
]);
/**
