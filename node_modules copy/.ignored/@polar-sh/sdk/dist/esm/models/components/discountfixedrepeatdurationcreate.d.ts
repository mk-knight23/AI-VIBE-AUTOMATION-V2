...
export type DiscountFixedRepeatDurationCreateMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type DiscountFixedRepeatDurationCreateMetadata$Outbound = string | number | number | boolean;
/** @internal */
