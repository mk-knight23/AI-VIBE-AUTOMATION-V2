...
/** @internal */
export const BenefitGrantDownloadablesWebhook$inboundSchema = z.object({
    ...
    previous_properties: z.nullable(BenefitGrantDownloadablesProperties$inboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
...
/** @internal */
export const BenefitGrantDownloadablesWebhook$outboundSchema = z.object({
    ...
    previousProperties: z.nullable(BenefitGrantDownloadablesProperties$outboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
 ...
 */
export var BenefitGrantDownloadablesWebhook$;
(function (BenefitGrantDownloadablesWebhook$) {
    /** @deprecated use `BenefitGrantDownloadablesWebhook$inboundSchema` instead. */
    BenefitGrantDownloadablesWebhook$.inboundSchema = BenefitGrantDownloadablesWebhook$inboundSchema;
    /** @deprecated use `BenefitGrantDownloadablesWebhook$outboundSchema` instead. */
    BenefitGrantDownloadablesWebhook$.outboundSchema = BenefitGrantDownloadablesWebhook$outboundSchema;
})(BenefitGrantDownloadablesWebhook$ || (BenefitGrantDownloadablesWebhook$ = {}));
export function benefitGrantDownloadablesWebhookToJSON(benefitGrantDownloadablesWebhook) {
    return JSON.stringify(BenefitGrantDownloadablesWebhook$outboundSchema.parse(benefitGrantDownloadablesWebhook));
}
export function benefitGrantDownloadablesWebhookFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BenefitGrantDownloadablesWebhook$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitGrantDownloadablesWebhook' from JSON`);
}
