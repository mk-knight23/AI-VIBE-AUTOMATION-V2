...
/** @internal */
export const BenefitMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const BenefitMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BenefitMetadata$;
...
export function benefitMetadataToJSON(benefitMetadata) {
    return JSON.stringify(BenefitMetadata$outboundSchema.parse(benefitMetadata));
}
export function benefitMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BenefitMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitMetadata' from JSON`);
}
/** @internal */
