...
/** @internal */
export const Costs$inboundSchema = z
    .union([z.number().int(), z.number()]);
/** @internal */
export const Costs$outboundSchema = z.union([z.number().int(), z.number()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
(function (Costs$) {
    ...
    Costs$.inboundSchema = Costs$inboundSchema;
    /** @deprecated use `Costs$outboundSchema` instead. */
    Costs$.outboundSchema = Costs$outboundSchema;
})(Costs$ || (Costs$ = {}));
export function costsToJSON(costs) {
    return JSON.stringify(Costs$outboundSchema.parse(costs));
}
export function costsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => Costs$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Costs' from JSON`);
}
/** @internal */
export const CumulativeCosts$inboundSchema = z.union([z.number().int(), z.number()]);
/** @internal */
export const CumulativeCosts$outboundSchema = z.union([z.number().int(), z.number()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CumulativeCosts$;
(function (CumulativeCosts$) {
    /** @deprecated use `CumulativeCosts$inboundSchema` instead. */
    CumulativeCosts$.inboundSchema = CumulativeCosts$inboundSchema;
    /** @deprecated use `CumulativeCosts$outboundSchema` instead. */
    CumulativeCosts$.outboundSchema = CumulativeCosts$outboundSchema;
})(CumulativeCosts$ || (CumulativeCosts$ = {}));
export function cumulativeCostsToJSON(cumulativeCosts) {
    return JSON.stringify(CumulativeCosts$outboundSchema.parse(cumulativeCosts));
}
export function cumulativeCostsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CumulativeCosts$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CumulativeCosts' from JSON`);
}
/** @internal */
