...
export type CustomFieldUpdateNumberMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type CustomFieldUpdateNumberMetadata$Outbound = string | number | number | boolean;
/** @internal */
