...
export type ProductCreateRecurringPrices = (ProductPriceMeteredUnitCreate & {
...
export type ProductCreateRecurring = {
     ...
     */
    prices: Array<(ProductPriceMeteredUnitCreate & {
        amountType: "metered_unit";
    }) | (ProductPriceFixedCreate & {
        amountType: "fixed";
    }) | (ProductPriceSeatBasedCreate & {
...
/** @internal */
export type ProductCreateRecurringPrices$Outbound = (ProductPriceMeteredUnitCreate$Outbound & {
...
export type ProductCreateRecurring$Outbound = {
    ...
    name: string;
    description?: string | null | undefined;
    prices: Array<(ProductPriceMeteredUnitCreate$Outbound & {
        amount_type: "metered_unit";
    }) | (ProductPriceFixedCreate$Outbound & {
        amount_type: "fixed";
    }) | (ProductPriceSeatBasedCreate$Outbound & {
