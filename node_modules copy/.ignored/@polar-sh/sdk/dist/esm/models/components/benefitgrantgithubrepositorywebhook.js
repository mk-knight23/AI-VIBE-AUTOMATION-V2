...
/** @internal */
export const BenefitGrantGitHubRepositoryWebhook$inboundSchema = z.object({
    ...
    previous_properties: z.nullable(BenefitGrantGitHubRepositoryProperties$inboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
...
/** @internal */
export const BenefitGrantGitHubRepositoryWebhook$outboundSchema = z.object({
    ...
    previousProperties: z.nullable(BenefitGrantGitHubRepositoryProperties$outboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
 ...
 */
export var BenefitGrantGitHubRepositoryWebhook$;
(function (BenefitGrantGitHubRepositoryWebhook$) {
    /** @deprecated use `BenefitGrantGitHubRepositoryWebhook$inboundSchema` instead. */
    BenefitGrantGitHubRepositoryWebhook$.inboundSchema = BenefitGrantGitHubRepositoryWebhook$inboundSchema;
    /** @deprecated use `BenefitGrantGitHubRepositoryWebhook$outboundSchema` instead. */
    BenefitGrantGitHubRepositoryWebhook$.outboundSchema = BenefitGrantGitHubRepositoryWebhook$outboundSchema;
})(BenefitGrantGitHubRepositoryWebhook$ || (BenefitGrantGitHubRepositoryWebhook$ = {}));
export function benefitGrantGitHubRepositoryWebhookToJSON(benefitGrantGitHubRepositoryWebhook) {
    return JSON.stringify(BenefitGrantGitHubRepositoryWebhook$outboundSchema.parse(benefitGrantGitHubRepositoryWebhook));
}
export function benefitGrantGitHubRepositoryWebhookFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BenefitGrantGitHubRepositoryWebhook$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitGrantGitHubRepositoryWebhook' from JSON`);
}
