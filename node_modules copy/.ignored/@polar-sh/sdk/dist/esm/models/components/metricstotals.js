...
/** @internal */
export const MetricsTotalsCosts$inboundSchema = z.union([z.number().int(), z.number()]);
/** @internal */
export const MetricsTotalsCosts$outboundSchema = z.union([z.number().int(), z.number()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var MetricsTotalsCosts$;
(function (MetricsTotalsCosts$) {
    /** @deprecated use `MetricsTotalsCosts$inboundSchema` instead. */
    MetricsTotalsCosts$.inboundSchema = MetricsTotalsCosts$inboundSchema;
    /** @deprecated use `MetricsTotalsCosts$outboundSchema` instead. */
    MetricsTotalsCosts$.outboundSchema = MetricsTotalsCosts$outboundSchema;
})(MetricsTotalsCosts$ || (MetricsTotalsCosts$ = {}));
export function metricsTotalsCostsToJSON(metricsTotalsCosts) {
    return JSON.stringify(MetricsTotalsCosts$outboundSchema.parse(metricsTotalsCosts));
}
export function metricsTotalsCostsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => MetricsTotalsCosts$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'MetricsTotalsCosts' from JSON`);
}
/** @internal */
export const MetricsTotalsCumulativeCosts$inboundSchema = z.union([z.number().int(), z.number()]);
/** @internal */
export const MetricsTotalsCumulativeCosts$outboundSchema = z.union([z.number().int(), z.number()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var MetricsTotalsCumulativeCosts$;
(function (MetricsTotalsCumulativeCosts$) {
    /** @deprecated use `MetricsTotalsCumulativeCosts$inboundSchema` instead. */
    MetricsTotalsCumulativeCosts$.inboundSchema = MetricsTotalsCumulativeCosts$inboundSchema;
    /** @deprecated use `MetricsTotalsCumulativeCosts$outboundSchema` instead. */
    MetricsTotalsCumulativeCosts$.outboundSchema = MetricsTotalsCumulativeCosts$outboundSchema;
})(MetricsTotalsCumulativeCosts$ || (MetricsTotalsCumulativeCosts$ = {}));
export function metricsTotalsCumulativeCostsToJSON(metricsTotalsCumulativeCosts) {
    return JSON.stringify(MetricsTotalsCumulativeCosts$outboundSchema.parse(metricsTotalsCumulativeCosts));
}
export function metricsTotalsCumulativeCostsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => MetricsTotalsCumulativeCosts$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'MetricsTotalsCumulativeCosts' from JSON`);
}
/** @internal */
