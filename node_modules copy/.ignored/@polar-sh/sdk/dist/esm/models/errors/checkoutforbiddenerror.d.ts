...
import { PaymentNotReady, PaymentNotReady$Outbound } from "./paymentnotready.js";
import { SDKValidationError } from "./sdkvalidationerror.js";
export type CheckoutForbiddenError = AlreadyActiveSubscriptionError | NotOpenCheckout | PaymentNotReady;
/** @internal */
export declare const CheckoutForbiddenError$inboundSchema: z.ZodType<CheckoutForbiddenError, z.ZodTypeDef, unknown>;
/** @internal */
export type CheckoutForbiddenError$Outbound = AlreadyActiveSubscriptionError$Outbound | NotOpenCheckout$Outbound | PaymentNotReady$Outbound;
/** @internal */
export declare const CheckoutForbiddenError$outboundSchema: z.ZodType<CheckoutForbiddenError$Outbound, z.ZodTypeDef, unknown>;
/**
 * @internal
...
export declare namespace CheckoutForbiddenError$ {
    ...
    const outboundSchema: z.ZodType<CheckoutForbiddenError$Outbound, z.ZodTypeDef, unknown>;
