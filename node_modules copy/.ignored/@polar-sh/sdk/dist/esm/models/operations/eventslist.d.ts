...
/** @internal */
export declare const NameFilter$inboundSchema: z.ZodType<NameFilter, z.ZodTypeDef, unknown>;
/** @internal */
export type NameFilter$Outbound = string | Array<string>;
/** @internal */
export declare const NameFilter$outboundSchema: z.ZodType<NameFilter$Outbound, z.ZodTypeDef, NameFilter>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace NameFilter$ {
    /** @deprecated use `NameFilter$inboundSchema` instead. */
    const inboundSchema: z.ZodType<NameFilter, z.ZodTypeDef, unknown>;
    /** @deprecated use `NameFilter$outboundSchema` instead. */
    const outboundSchema: z.ZodType<NameFilter$Outbound, z.ZodTypeDef, NameFilter>;
    /** @deprecated use `NameFilter$Outbound` instead. */
    type Outbound = NameFilter$Outbound;
}
export declare function nameFilterToJSON(nameFilter: NameFilter): string;
export declare function nameFilterFromJSON(jsonString: string): SafeParseResult<NameFilter, SDKValidationError>;
/** @internal */
