...
import { CheckoutStatus$inboundSchema, CheckoutStatus$outboundSchema, } from "../components/checkoutstatus.js";
...
/** @internal */
export const CheckoutsListQueryParamCustomerIDFilter$inboundSchema = z.union([z.string(), z.array(z.string())]);
/** @internal */
export const CheckoutsListQueryParamCustomerIDFilter$outboundSchema = z.union([z.string(), z.array(z.string())]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CheckoutsListQueryParamCustomerIDFilter$;
(function (CheckoutsListQueryParamCustomerIDFilter$) {
    ...
    CheckoutsListQueryParamCustomerIDFilter$.inboundSchema = CheckoutsListQueryParamCustomerIDFilter$inboundSchema;
    /** @deprecated use `CheckoutsListQueryParamCustomerIDFilter$outboundSchema` instead. */
    CheckoutsListQueryParamCustomerIDFilter$.outboundSchema = CheckoutsListQueryParamCustomerIDFilter$outboundSchema;
})(CheckoutsListQueryParamCustomerIDFilter$ || (CheckoutsListQueryParamCustomerIDFilter$ = {}));
export function checkoutsListQueryParamCustomerIDFilterToJSON(checkoutsListQueryParamCustomerIDFilter) {
    return JSON.stringify(CheckoutsListQueryParamCustomerIDFilter$outboundSchema.parse(checkoutsListQueryParamCustomerIDFilter));
}
export function checkoutsListQueryParamCustomerIDFilterFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CheckoutsListQueryParamCustomerIDFilter$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CheckoutsListQueryParamCustomerIDFilter' from JSON`);
}
/** @internal */
export const StatusFilter$inboundSchema = z.union([
    CheckoutStatus$inboundSchema,
    z.array(CheckoutStatus$inboundSchema),
]);
/** @internal */
export const StatusFilter$outboundSchema = z.union([
...
(function (StatusFilter$) {
    ...
    StatusFilter$.inboundSchema = StatusFilter$inboundSchema;
    /** @deprecated use `StatusFilter$outboundSchema` instead. */
    StatusFilter$.outboundSchema = StatusFilter$outboundSchema;
})(StatusFilter$ || (StatusFilter$ = {}));
export function statusFilterToJSON(statusFilter) {
    return JSON.stringify(StatusFilter$outboundSchema.parse(statusFilter));
}
export function statusFilterFromJSON(jsonString) {
    return safeParse(jsonString, (x) => StatusFilter$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'StatusFilter' from JSON`);
}
/** @internal */
