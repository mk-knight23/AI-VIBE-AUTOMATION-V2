...
/** @internal */
export const NameFilter$inboundSchema = z.union([z.string(), z.array(z.string())]);
/** @internal */
export const NameFilter$outboundSchema = z.union([z.string(), z.array(z.string())]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
(function (NameFilter$) {
    ...
    NameFilter$.inboundSchema = NameFilter$inboundSchema;
    /** @deprecated use `NameFilter$outboundSchema` instead. */
    NameFilter$.outboundSchema = NameFilter$outboundSchema;
})(NameFilter$ || (NameFilter$ = {}));
export function nameFilterToJSON(nameFilter) {
    return JSON.stringify(NameFilter$outboundSchema.parse(nameFilter));
}
export function nameFilterFromJSON(jsonString) {
    return safeParse(jsonString, (x) => NameFilter$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'NameFilter' from JSON`);
}
/** @internal */
