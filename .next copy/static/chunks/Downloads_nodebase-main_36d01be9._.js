...
const createRays = (count, cycle)=>{
    ...
    return Array.from({
        ...
        return {
            id: "".concat(index, "-").concat(Math.round(left * 10)),
            left,
            rotate,
            width,
            swing,
...
const Ray = (param)=>{
    let { left, rotate, width, swing, delay, duration, intensity } = param;
...
_c = Ray;
function LightRays(param) {
    let { className, style, count = 7, color = "rgba(160, 210, 255, 0.2)", blur = 36, speed = 14, length = "70vh", ref, ...props } = param;
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$nodebase$2d$main$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        style: {
            ...
            "--light-rays-blur": "".concat(blur, "px"),
